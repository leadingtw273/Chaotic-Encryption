...
module.exports = {
    ...
    createUk: (X, Y) => {
        ...
        let u = f.round((X[0] * (1 - c1 - A) + X[1] * (- X[1] - (A * c1) + c1 - c2) + X[2] * ((- A * c2) + c2 + 0.1)) + (Y[0] * (- 1 + A + c1) + Y[1] * (- Y[1] + (A * c1) + c2 - c1) + Y[2] * ((A * c2) - 0.1 - c2)), 10);
    ...
    createUm: (X) => {
        ...
        let s = f.round((Y[0] - X[0]) + (c1 * (Y[1] - X[1])) + (c2 * (Y[2] - X[2])), 10);
        let u = f.round(-((X[1] ** 2) - (Y[1] ** 2) - (0.1 * (Y[2] - X[2])) + (c1 * (Y[0] - X[0])) + (c2 * (Y[1] - X[1])) - (Y[0] - X[0]) - (c1 * (Y[1] - X[1])) - (c2 * (Y[2] - X[2])) + (A * s), 10));


        (X[0] * (1 - c1 - A) + X[1] * (- X[1] - (A * c1) + c1 - c2) + X[2] * (- A * c2 + c2 + 0.1))
            // + X[0] * (1 - c1 - A)
            ...
            + Y[0] * (- 1 + A + c1) + Y[1] * (- Y[1] + (A * c1) + c2 - c1) + Y[2] * (A * c2 - 0.1 - c2)
        // + Y[0] * (- 1 + A + c1)
