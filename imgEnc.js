...
const inputFileName = '5000.jpg';
const outputAesFileName = 'enc_aes_5000.txt';
const outputChaosFileName = 'enc_chaos_5000.txt';
...
readStream.on('readable', () => {
  while (null !== (chunk = readStream.read(8))) {
    count++;

    let cry = crypt(chunk.toString('hex'),count,true);
    let ae = aes(chunk.toString('hex'),true);
    ...
    console.log(chunk.toString('hex').length);
    console.log('--------------------');
    console.log(cry);
